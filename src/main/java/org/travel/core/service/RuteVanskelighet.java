...
// 1 i stoppmengde er en rute som har mindre enn 5 stopp fra start til slutt
// 10 i stoppmengde er en rute som har fler enn 50 stopp fra start til slutt
...
public class RuteVanskelighet {
    private int VanskelighetsGradLengde = -1;
    private int VanskelighetsGradStopp = -1;
    private int VanskelighetsGradTravelhet = -1; // Ubrukt for nå, i testing bør denne alltid være -1


    public int RuteVanskelighetKalkulatorLengde(Route route) {
        ...
        */
        return VanskelighetsGradLengde;
    }

    public int RuteVanskelighetKalkulatorStopp(Route route) {
        ...
        if (route.getStops().isEmpty()) {
            ...
            return VanskelighetsGradStopp = -1;
        }
        else {
            for (int stop = 0; stop < route.getStops().size(); stop++) {
                if (VanskelighetsGradStopp == 10) break;
                if (stop % 5 == 0) {
                    VanskelighetsGradStopp++;
                }
            }
        }
        return VanskelighetsGradStopp;
    }

    public int RuteVanskelighetKalkulatorTravelhet(Route route) {
        // Gjør ingenting for nå
        return VanskelighetsGradTravelhet;
    }
}
